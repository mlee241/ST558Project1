...
This will produce a table of the team.stats modifier from the NHL Stats API and return all the data from all teams.
...
. You should create at least two new variables that are functions of the variables from a data set you use
 All plots should have nice labels and titles. 5 plots
. 
