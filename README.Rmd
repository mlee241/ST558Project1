...
This will produce a table of the team.stats modifier from the NHL Stats API and return all the data from all teams. Note that I did not output the `wrap` because it is the same output as `kable(team.stats)`.
